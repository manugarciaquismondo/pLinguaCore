...
public class Communication {
	...
	private EvolutionCommunicationKernelLikeRule rule;
	private long executions;
	public Communication(TissueLikeMembrane firstMembrane,
			TissueLikeMembrane secondMembrane,
			EvolutionCommunicationKernelLikeRule rule, long executions) {
		super();
	...
	public EvolutionCommunicationKernelLikeRule getRule() {
		return rule;
	}
